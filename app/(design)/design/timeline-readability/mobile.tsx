...
function MNight({ night }: { night: NightData }) {
  return (
    <div className="my-1 flex flex-col rounded-md border border-border bg-surface px-2.5 py-1.5">
      ...
      <div className="flex items-center justify-between border-t border-border pt-1 text-[10px] text-ink-soft">
        <span className="tabular-nums">

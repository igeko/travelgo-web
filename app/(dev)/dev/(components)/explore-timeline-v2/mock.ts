 ...
 * with timed + fuzzy stops + an accommodation per day, so the organism
 * (rail, time alignment and the primary-accent lodging row) can be
 * verified without an authenticated trip snapshot.
 *
...
export const MOCK_DAYS: TimelineDayData[] = [
  day({
    ...
    date: "2026-08-05",
    city: "Tokyo",
    accommodation_name: "Hotel Tavinos Asakusa",
    accommodation_type: "hotel",
    accommodation_address: "Asakusa, Tokyo",
    activities: [
      act({ id: "a1", position: 0, time: "08:30", title: "Haneda Airport Terminal 1-2", icon: "info" }),
      act({ id: "a3", position: 1, fuzzy: true, title: "Caffè Specialty", icon: "coffee" }),
      act({ id: "a4", position: 2, time: "12:30", title: "Ritiro Camper", icon: "car", short_desc: "Pickup del camper per il tour." }),
      act({ id: "a5", position: 3, time: "16:00", title: "Spesa Beisia Tomisato", icon: "market" }),
    ],
  }),
  day({
    day_number: 2,
    ...
    accommodation_name: "Nikko Daiyagawa Park Auto",
    accommodation_type: "campground",
    accommodation_address: "Nikko, Tochigi",
    activities: [
      act({ id: "b2", position: 0, time: "10:30", title: "Santuario Toshogu e Rinno-ji", icon: "monument", short_desc: "Complesso di santuari patrimonio UNESCO." }),
      act({ id: "b3", position: 1, time: "13:00", title: "Bosco di Cedri", icon: "park" }),
      act({ id: "b4", position: 2, time: "15:00", title: "Abisso di Kanmangafuchi", icon: "view" }),
      act({ id: "b5", position: 3, fuzzy: true, title: "Wanoshiro Onsen", icon: "swim" }),
    ],
  }),
];
